                    ...
                    <table style="margin-top: 10px; font-size:18px; line-height: 1.2; text-align: center; font-weight: bold;">
                        ...
                        <tr>
                            <td>
                                ...
                                <br>
                                {{ $meeting->location }} <br>
                                Date & Time: {{ \Carbon\Carbon::parse($meeting->date_and_time)->format('d-M-Y H:i:s') }} <sub>PST <span style="font-size: 3px;margin: 0px; padding: 0px;">{{\Illuminate\Support\Facades\Auth::user()->id}}</span></sub>
                                <br>
